...
/**
 * Class EventsHttpHandler
 *
 * This is a configurable handler that lists events.
 *
 * @author Matias Navarro Carter <mnavarro@option.cl>
 */
class EventsHttpHandler implements MiddlewareInterface
{
    /**
    ...
    {
        $stream = $request->getAttribute('stream', 'master');
        // TODO: Create a content-Type maker that creates data from a stream.
        // TODO: Will do json, html, xml and atom-feeds
    ...
    {
        $events = new JsonEventStream($events);
